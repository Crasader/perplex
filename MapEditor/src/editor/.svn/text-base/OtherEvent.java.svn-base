...
class PlayMusic
	...
	public String getListItemDescription() {
		String result = "²¥·ÅµÚ" + musicID + "ºÅÒôÀÖ";
		return result;
	}
...
class PlayMusicSetter
	...
	public PlayMusicSetter(JDialog owner, MainFrame mainFrame, PlayMusic playMusic) {
		...
		cp.add(new JLabel("ÒôÀÖ±àºÅ£º"), c);
...
class ChangeMap
	...
	public String getListItemDescription() {
		String result = "ÇĞ»»µ½µÚ" + stageID + "´ó¹ØµÚ" + mapID + "Ğ¡½Ú";
		return result;
	}
...
class ChangeState
	...
	public final static String getDesc(int state) {
		String result = "Î´Öª×´Ì¬";
		if(state >= 0 && state < STATES.length) {
			result = "×´Ì¬[" + DESCS[state] + "]";
		}
		return result;
	}
	...
	public String getListItemDescription() {
		String result = "ÇĞ»»µ½" + ChangeState.getDesc(state);
		return result;
	}
